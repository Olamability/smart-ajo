...
-- ============================================================================
-- Note: This function definition is now in functions.sql.
-- We drop the old 3-parameter version and don't recreate the function here
-- to avoid duplicate function errors.
-- ============================================================================

-- Drop old 3-parameter version if it exists
DROP FUNCTION IF EXISTS process_group_creation_payment(VARCHAR, UUID, UUID);

-- The 4-parameter version is defined in functions.sql
